                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" id="address" value="{{ $clientDetail->address ?? '' }}"  class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Ref #</label>
                                                <input type="text" name="note" id="note" class="form-control" value="{{ $clientDetail->note ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
