    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            {{--@if(in_array('attendance',$modules))--}}
                {{--<li><a href="{{ route('admin.attendances.summary') }}" class="waves-effect"><i class="icon-clock"></i> <span class="hide-menu">@lang('app.menu.attendance') </span></a> </li>--}}
            {{--@endif--}}
            ...
            {{--@if(in_array('leaves',$modules))--}}
                {{--<li><a href="{{ route('admin.leaves.pending') }}" class="waves-effect"><i class="icon-logout"></i> <span class="hide-menu">@lang('app.menu.leaves')</span></a> </li>--}}
            {{--@endif--}}
